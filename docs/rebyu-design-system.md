...
| Token | Hex | Use |
| --- | --- | --- |
| `rb-feather` | `#58CC02` | Primary actions, brand anchor. Lean here when unsure. |
| `rb-mask` | `#89E219` | Success, progress fills, completion |
...
| `rb-bee` | `#FFC800` | Achievements, rewards, milestones |
