...
import { getInstitutionLicense } from "@/services/subscriptionService.js"
...
export default function InstitutionLicensePage() {
  ...
  const licenseQuery = useQuery({
    queryKey: ["institution-license", institutionId],
    queryFn: () => getInstitutionLicense(institutionId),
  ...
  return (
    <div className="space-y-6">
      ...
      {licenseQuery.isLoading ? (
        ...
        <InstitutionErrorState onRetry={licenseQuery.refetch} />
      ) : !hasLicense ? (
        <InstitutionEmptyState
          icon={SparklesIcon}
          ...
          <Card>
            <CardHeader className="pb-3">
              <div className="flex flex-wrap items-center justify-between gap-2">
                ...
                <InstitutionStatusBadge status={license.licenseStatus} />
              </div>
            </CardHeader>
            <CardContent>
