...
import EnterpriseBillingPage from "./enterprise-billing-page.jsx"
import EnterpriseFilesPage from "./enterprise-files-page.jsx"
import EnterpriseLicensePage from "./enterprise-license-page.jsx"
import EnterpriseOrganizationPage from "./enterprise-organization-page.jsx"
import EnterprisePartnershipPage from "./enterprise-partnership-page.jsx"
...
const TABS = [
  {
    ...
    label: "Profile",
    icon: Building2Icon,
    Panel: EnterpriseOrganizationPage,
  },
  {
    value: "partnership",
    ...
    label: "Partnership",
    icon: HandshakeIcon,
    Panel: EnterprisePartnershipPage,
  },
  {
    value: "license",
...
export default function EnterpriseAccountPage() {
  ...
  const isEnterpriseMember =
    Boolean(user?.enterpriseMemberRole) && user.enterpriseMemberRole !== "owner"
  const tabs = isEnterpriseMember ? TABS.filter((tab) => tab.value === "files") : TABS
