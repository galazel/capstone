...
/**
 * Read-only certification content viewer for Enterprise Members, modelled on
 ...
 */
export default function EnterpriseCertificationViewerPage() {
  ...
  return (
    <div className="flex h-[calc(100vh-4rem)] flex-col">
      <div className="flex items-center gap-3 border-b border-border px-4 py-3">
        ...
        <Link
          to={groupId ? `/enterprise/groups/${groupId}` : "/enterprise/certifications"}
