...
const QUESTION_TYPE_STYLES = {
  ...
  SHORT_ANSWER: {
    label: "Short Answer",
<<<<<<< Updated upstream:frontend/src/pages/learner/learner-assessment-attempt-page.jsx
    className:
        "border-violet-200 bg-violet-50 text-violet-700 dark:border-violet-800 dark:bg-violet-950/40 dark:text-violet-300",
=======
    className: "border-rb-macaw bg-rb-macaw-wash text-rb-macaw-lip",
>>>>>>> Stashed changes:frontend/src/pages/learner/assessments/learner-assessment-attempt-page.jsx
  },
  DESCRIPTIVE: {
    label: "Descriptive",
