                      ...
                      <div className="mt-2 flex flex-wrap justify-center gap-1">
                        {challenge.tracks.length > 0 ? (
                          challenge.tracks.slice(0, 3).map((track) => (
                            <span
                              key={track.id}
                              className="max-w-full truncate rounded-full bg-zinc-950/5 px-2 py-0.5 text-[10px] font-semibold text-zinc-600"
                            >
                              {track.name}
                            </span>
                          ))
                        ...
                        {challenge.tracks.length > 3 ? (
                          <span className="rounded-full bg-zinc-950/5 px-2 py-0.5 text-[10px] font-semibold text-zinc-600">
                            +{challenge.tracks.length - 3}
                          </span>
                        ) : null}
                      </div>
