...
ALTER TABLE enterprise_members ADD COLUMN IF NOT EXISTS first_name VARCHAR(100) NULL;
ALTER TABLE enterprise_members ADD COLUMN IF NOT EXISTS last_name VARCHAR(100) NULL;
