...
class AccountDeletionServiceTest {
    ...
    void deleteLearner_ordersAssessmentTreeAndCertificationDiamondCorrectly() {
        ...
        int attemptsLeaf = indexOfLeafDelete(statements, "assessment_attempts");
        ...
        int orders = indexOfLeafDelete(statements, "learner_orders");
     ...
     * filter their own subqueries by "FROM assessment_attempts WHERE
     * learner_id", which a loose contains() check would match first).
     */
    private int indexOfLeafDelete(List<String> statements, String table) {
